...
<feed xmlns="http://www.w3.org/2005/Atom">
  ...
  @foreach ($posts as $post)
    <entry>
        ...
        <link rel="alternate" type="text/html" href="{{ strtolower(route('web.posts.show', $post->title)) }}" />
        <id>{{ strtolower(route('web.posts.show', $post->title)) }}</id>
        ...
        <summary type="text"><![CDATA[{!! mb_str_limit(strip_tags($post->html_content), 500, '...') !!}]]></summary>
    </entry>
  @endforeach
</feed>
