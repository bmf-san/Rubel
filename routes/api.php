...
Route::group(['middleware' => 'auth:admin', 'prefix' => 'admin'], function () {
	...
	Route::get('category/create', 'Api\v1\Category\Categoryontroller@create');
	Route::get('category/{id}/edit', 'Api\v1\Category\Categoryontroller@edit');
	Route::get('category/{id}/delete', 'Api\v1\Category\Categoryontroller@delete');
});
